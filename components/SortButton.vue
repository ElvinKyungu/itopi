...
<template>
  <div class="h-14 w-56">
    <div class="h-full w-full flex items-center justify-between font-medium" v-bind:class="{ 'bg-zinc-100 rounded-t-lg border-l-2 border-t-2 border-r-2 border-black': showOption }">
